<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="nino_id" class="form-control @error('nino_id') is-invalid @enderror" value="{{ old('nino_id', $enfermedade?->nino_id) }}" id="nino_id" placeholder="Nino Id">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="estado" class="form-control @error('estado') is-invalid @enderror" value="{{ old('estado', $enfermedade?->estado) }}" id="estado" placeholder="Estado">
